...
require_once('../lib/vote_article.php');
require_once('../lib/vote_article2.php');
require_once('../lib/vote_chaque_article.php');
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../panel/upload/<?php echo $resultat_articleFiche[0]['image_article'] ?>" alt="image_article" /></div>
                        <div class="col-md-6">
                            <div class="small mb-1">SKU: BST-498</div>
                            <h1 class="display-5 fw-bolder"><?php echo $resultat_articleFiche[0]['title_article']; ?></h1>
                            <div class="fs-5 mb-5">
                                <span> Prix :<?php echo $resultat_articleFiche[0]['price_article']; ?> €</span>
                            </div>
                                <p class="lead"><?php echo $resultat_articleFiche[0]['description_article'] ?></p>
                                <p class="lead"><?php echo $resultat_articleFiche[0]['text_article'] ?></p>
                                

                                <?php if ($nombre_de_vote > 0) {
                               ...
                               <?php
                                ...
                                <!-- affichage vote à partir d'une requete sql depuis le fichier vote_article -->
                                <p class="text-info" >Rated : " <?php echo $moyenne_vote; ?> "</p>
                            <div class="d-flex">
                        ...
                        <!-- formulaire vote (il va chercher la variable stockée dans le fichier "vote_article") -->
                            <?php if (!empty($_SESSION['id_utilisateur'])) { ?>
                                <?php if (mysqli_num_rows($stock_resultat_vote) > 0) { ?>

                                    <h4>Votre vote a été pris en compte!!</h4>
                                <?php 
                            } else { ?> 
                                    <form method="post" id="vote_formulaire">
                                        <div class="d-flex">                               
                                                <input class="form-control text-center me-3" id="inpuVote" type="num" name="vote_article" value="1" style="max-width: 3rem" />
                                                <input class="btn btn-outline-dark flex-shrink-0" type="submit" value="voter" >
                                        </div>
                                    </form>
                                    <?php 
                                } ?>
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <?php foreach ($resultat_article as $tableau_fiche_article) {
                          if ($tableau_fiche_article['id_article'] !=$_GET['id_article']){
                            $iteration=0;
                             foreach($resultatAllCommentsAll as $key_vote => $value_vote){

                                if($value_vote['id_article'] == $tableau_fiche_article['id_article']){
                                    // echo "<pre>";
                                    // print_r($value_vote);
                                    // echo "</pre>";
                                    $tableau_fiche_article['commentaire'][$iteration] = $value_vote;
                                    $iteration++;
                                }
                            }
                            ...
                            foreach($tableau_fiche_article['commentaire'] as $article_vote){
                            ...
                            if($tableau_fiche_article['commentaire'][0]){
                                $nbr_votes = sizeof($tableau_fiche_article['commentaire']);
                                // echo "<br>".$nbr_votes;
                            }
                            error_reporting(E_ALL);
                        ...
                        <div class="col mb-5">
                            <div class="col mb-5">
                                <div class="card h-100">
                                    <!-- Product image-->
                                    <img class="card-img-top" src="../panel/upload/<?php echo $tableau_fiche_article['image_article'] ?>" alt="..." />
                                    <!-- Product details-->
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            <!-- Product name-->
                                            <h5 class="fw-bolder">Produit : <?php echo $tableau_fiche_article['title_article'] ?></h5>
                                            <!-- Product reviews-->
                                            <p class="card-text mb-auto">Description : <?php echo $tableau_fiche_article['description_article'] ?></p>
                                            ...
                                            <!-- Product price-->
                                        <p> Prix :<?php echo $tableau_fiche_article['price_article'] ?> €</p>
                                            <p class="card-text mb-auto">Quantité : <?php echo $tableau_fiche_article['quantity'] ?></p>
                                    ...
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="?id_article=<?php echo $tableau_fiche_article['id_article']; ?>">Add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
