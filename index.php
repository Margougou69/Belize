            ...
            <div class="col mb-5">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="panel/upload/<?php echo $tableau2['image_article'] ?>" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder">Produit : <?php echo $tableau2['title_article'] ?></h5>
                                <!-- Product reviews-->
                                <p class="card-text mb-auto">Description : <?php echo $tableau2['description_article'] ?></p>

                                
                                <!-- Product price-->
                               <p> Prix :<?php echo $tableau2['price_article'] ?> €</p>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                             <a class="btn btn-outline-dark mt-auto"href="fiche_article/index.php?id_article=<?php echo $tableau2['id_article'];?>">Plus de détails</a>
